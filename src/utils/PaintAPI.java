...
public class PaintAPI extends API {
	...
	public  void drawTileKetto(Script script, Graphics2D g, Entity entity, Color tileColor, Color textColor) {

		/* PÉLDA KÓD
		if (myPlayer().getInteracting() != null) {
                drawTile(client.getBot().getScriptExecutor().getCurrent(), g, myPlayer().getInteracting(), Color.green, Color.white, "" + myPlayer().getInteracting().getHealth());
            }
		*/
	...
	public void drawEntitiesKetto(Graphics2D g, Entity entity) {
